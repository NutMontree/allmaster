...
import WorksCard from './Card/Card'
    ...
    <section>
      <div className='container max-w-8xl mx-auto px-5 2xl:px-0'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-10'>
          {workHomes.slice(0, 6).map((item, index) => (
