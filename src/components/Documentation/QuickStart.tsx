    ...
    <div className="pb-10 md:scroll-m-[180px] scroll-m-28" id="start">
      ...
      <div className="p-6 rounded-md border mt-6 border-black/10 dark:border-white/20">
        ...
        <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">
          ...
          <a href="https://nodejs.org/" className="text-[#EFBF04]">
            node.js
          </a>{" "}
        </p>
      ...
      <div className="p-6 rounded-md border mt-6 border-black/10 dark:border-white/20">
        ...
        <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50 mb-4">
        ...
        <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50 my-4">
          This command will start a local webserver{" "}
          <span className="dark:text-white">http://localhost:3000:</span>
        </p>
        <div className="py-4 px-3 rounded-md bg-black">
          <p className="text-sm text-gray-400">
            {"> AllMaster-nextjs@1.0.0 dev"}
          </p>
      ...
      <div className="p-6 rounded-md border mt-6 border-black/10 dark:border-white/20">
        ...
        <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50 mt-6">
