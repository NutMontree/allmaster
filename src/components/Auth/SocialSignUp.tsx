        ...
        <>
            <div className="flex gap-4">
                <button
                    ...
                    className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-border dark:border-darkborder p-3.5 text-dark duration-200 ease-in  dark:border-darkborder dark:text-white dark:hover:bg-[#EFBF04]/10 hover:bg-[#EFBF04]/10"
                >
                    Sign Up
                    <svg
                        width="23"
