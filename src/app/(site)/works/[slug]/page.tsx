        ...
        <div className="grid grid-cols-12 gap-8 mt-10">
          <div className="lg:col-span-8 col-span-12">
              ...
              <div className="flex items-center gap-6">
                <div>
                  <svg
                    ...
                    width="35"
                    height="35"
                    className="w-8 h-8 dark:hidden fill-black dark:fill-amber-50"
                    fill="#9fb91d"
                    viewBox="0 0 256 256"
                  >
                    <path
                  ...
                  <svg
                    ...
                    width="35"
                    height="35"
                    className="w-8 h-8 dark:block hidden fill-black dark:fill-amber-50"
                    viewBox="0 0 256 256"
                  >
                    <path
                      d="M208,104a79.86,79.86,0,0,1-30.59,62.92A24.29,24.29,0,0,0,168,186v6a8,8,0,0,1-8,8H96a8,8,0,0,1-8-8v-6a24.11,24.11,0,0,0-9.3-19A79.87,79.87,0,0,1,48,104.45C47.76,61.09,82.72,25,126.07,24A80,80,0,0,1,208,104Z"
            ...
            <div className="flex flex-col gap-5">
              <p className="text-dark dark:text-white text-xm "></p>
          ...
          <div className="lg:col-span-4 col-span-12">
            <div className="bg-[#EFBF04]/10 p-8 rounded-2xl relative z-10 overflow-hidden">
              ...
              <Link
                href="/contactus"
                className="py-4 px-8 bg-[#EFBF04] text-white rounded-full w-full block text-center hover:bg-dark duration-300 text-base mt-8 hover:cursor-pointer"
              >
                Get in touch
              </Link>
